...
function injectContext(FormComponent) {
    ...
    function interceptChangesAndInject(schemaProperties, field, context) {
        if ((0, _utils.inputSelectSource)(schemaProperties) && field) {
            // Get the source
            ...
            source.map(function (sourceItem) {
                ...
                if (context[(0, _utils.inputSelectSource)(schemaProperties)]) {
                    field[sourceItem.field].comboData = context[(0, _utils.inputSelectSource)(schemaProperties)].map(function (f) {
