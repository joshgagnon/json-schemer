        ...
        if ((0, _utils.inputSelectSource)(schemaProperties) && fields[key]) {
            (function () {
                ...
                fields[key][source].onChange = function (event) {
                    ...
                    var contextEventMatch = context[(0, _utils.inputSelectSource)(schemaProperties)].find(function (f) {
                        return f[source] === event;
                    });

                    if (contextEventMatch) {
                        (function () {
                            var _keyIndex = contextEventMatch._keyIndex,
                                result = _objectWithoutProperties(contextEventMatch, ['_keyIndex']);
